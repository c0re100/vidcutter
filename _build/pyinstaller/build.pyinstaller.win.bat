...
if exist "dist\VidCutter_HuskyVer.exe" (
    ...
    .\verpatch.exe dist\VidCutter_HuskyVer.exe /va %APPVER%.6 /pv %APPVER%.6 /s desc "VidCutter Husky Version" /s name "VidCutter Husky Version" /s copyright "(c) 2024 Husky" /s product "VidCutter %BINARCH%" /s company "husky.dev"
